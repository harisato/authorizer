...
// Siwe is the resolver for the siwe field.
func (r *mutationResolver) Siwe(ctx context.Context, params model.EvmWalletLoginInput) (*model.AuthResponse, error) {
	return resolvers.EvmWalletLoginResolver(ctx, params)
}
...
func (r *mutationResolver) EvmWalletLogin(ctx context.Context, params model.EvmWalletLoginInput) (*model.AuthResponse, error) {
	return resolvers.EvmWalletLoginResolver(ctx, params)
}
