...
type User struct {
	...
	ZaloId                   string  `json:"zalo_id" bson:"zalo_id" cql:"zalo_id" dynamo:"zalo_id" index:"zalo_id,hash"`
	WalletAddress            string  `json:"wallet_address" bson:"wallet_address" cql:"wallet_address" dynamo:"wallet_address" index:"wallet_address,hash"`
